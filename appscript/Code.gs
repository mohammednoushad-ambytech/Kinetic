...
function handleCreateProject(body) {
  ...
  if (body.created_by) {
    ...
    // Also add to legacy permissions table for backward compatibility
    var legacyMappingId = generateId('M', 'user_project_permissions', 'mapping_id');
    appendRow('user_project_permissions', {
      mapping_id: legacyMappingId,
      user_id_fk: body.created_by,
      project_id_fk: newProject.project_id,
      can_read: true,
      can_create: true,
